...
KEYS = ['OA11CD', 'region_name', 'Town', 'bua_code', 'lsoa_code', 'msoa_code', 'population', 'Area', 'density', 'constituency_name', 'urban', 'geometry']

_precision = _set_precision(5)
POINTS = gp.GeoDataFrame(geometry=DENSITY.centroid, crs=CRS).to_crs('EPSG:4326')
